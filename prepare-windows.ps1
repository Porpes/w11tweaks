...
iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/porpes/w11tweaks/master/install-winget.ps1'));

Write-Host "Essential tweaks..."
iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/porpes/w11tweaks/master/windows-tweaks.ps1'));
...
iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/porpes/w11tweaks/master/install-essential-apps.ps1'));
